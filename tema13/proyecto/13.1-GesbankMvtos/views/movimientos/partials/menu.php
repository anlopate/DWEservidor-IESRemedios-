        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link 
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['movimientos']['order'])? 'active': 'disabled' ?> dropdown-toggle"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>movimientos/order/3">Fecha/hora</a></li>
            ...
            <form class="d-flex" role="search" method="GET" action="<?= URL ?>movimientos/filter">
                ...
                <?= in_array($_SESSION['id_rol'], $GLOBALS['movimientos']['filter'])? null: 'disabled' ?>"
