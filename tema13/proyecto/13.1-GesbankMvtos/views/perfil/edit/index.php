                    ...
                    <div class="card-body">
                        <form method="POST" action="<?=URL?>perfil/valperfil">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control <?= (isset($this->errores['name']))? 'is-invalid': null ?>" name="name" value="<?= $this->user->name; ?>" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="email" class="form-control <?= (isset($this->errores['email']))? 'is-invalid': null ?>" name="email" value="<?= $this->user->email; ?>" >
