...
<body>
    ...
    <div class="row justify-content-center">
            ...
            <?php require_once("template/partials/error.php") ?>
                <div class="card">
                    <div class="card-header">Perfil <?= $this->usuario->name; ?></div>
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="name" value="<?= $this->usuario->name; ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-9 offset-sm-3">
                                    <a class="btn btn-secondary" href="<?=URL?>usuario" role="button">Salir</a>
                                </div>
                            </div>
