            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="ordenar.php?criterio=2">Alumno</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=3">Email</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=4">Teléfono</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=5">Población</a></li>
