    ...
    <div class="container">
        ...
        <form>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="id" value="<?=$this->id?>" disabled>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="id_cliente" value="<?=$this->cuenta->id_cliente?>" disabled>
            </div>
