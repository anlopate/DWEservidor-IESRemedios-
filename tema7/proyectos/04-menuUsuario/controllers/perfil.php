<?php
    ...
    class Perfil Extends Controller {
         ...
         public function render() {
            ...
            # Creamos objeto user en la vista con los detalles del usuarioque se guarda en la variable de sesión ID.
            $this->view->user = $this->model->getUserId($_SESSION['id']);
            $this->view->title = 'Perfil del Usuario - Gestión Alumnos FP - MVC';
        ...
        public function valperfil() {
            ...
            # Obtenemos objeto con los detalles del usuario. Para ver si ha modificado algo.
