     ...
     <div class="container">
        ...
        <form action="create.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="dni" pattern="[0-9]{8}[A-Z]{1}"><!--validación DNI -->
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="id_curso">
                    <option selected disabled>Seleccione Curso</option><!--DEvuelve un objeto pdo statement-->
