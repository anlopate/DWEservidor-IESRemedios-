     ...
     <div class="container">
        ...
        <form action="create.php" method="POST">
            ...
            <div class="mb-3">
               ...
               <input type="checkbox" class="form-check-input" value="hombre" name="genero" id="hombre">
               <label id="hombre" class="form-check-label">Hombre</label>
               <input type="checkbox" class="form-check-input" value="mujer" name="genero" id="mujer">
               <label id="mujer" class="form-check-label">Mujer</label>
               <input type="checkbox" class="form-check-input" name="genero" value="sinesp" for="mujer">
            </div>
