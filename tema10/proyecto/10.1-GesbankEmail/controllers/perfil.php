...
require 'controllers/Contactar.php';
    ...
    class Perfil Extends Controller {
        ...
        public function render() {
            ...
            $this->view->title = 'Perfil de Cliente - Gestión Gesbank - MVC';
        ...
        public function edit() {
            ...
            $this->view->title = 'Modificar Perfil Cliente - Gesbank - FP';
        ...
        public function valperfil() {
            ...
            if (!empty($errores)) {
                ...
                $contacto = new classContactar(
                    $nombre = $name,
                    $email =  $email,
                    $asunto = 'Cambios en su perfil',
                    $mensaje = "Estimado cliente:<br><br> Le Informamos que se ha producido un cambio en su perfil.<br><br>Si usted no ha realizado esos cambios, pongáse en contacto con nuestro servicio de atención al cliente.<br><br>Si lo ha realizado usted, ignore este email.<br><br>Atentamente,<br><br>Dpto. de serguridad.");
        ...
        public function valpass() {
            ...
            if (!empty($errores)) {
                ...
                $nombre = $user->name,
                $email =  $user->email,
                $asunto = 'Cambios en su contraseña',
                $mensaje = "Estimado cliente:<br><br> Le Informamos que se ha modificado su contraseña.<br><br>Le recordamos que su nueva contraseña es:<br><br> - <b>Password</b>: $password<br><br>Atentamente,<br><br>Dpto. de seguridad. ");
            ...
            if (!isset($_SESSION['id'])) {
                ...
                header("location:".URL. "login");
                  ...
                  $contacto = new classContactar(
                    ...
                    $mensaje = "Estimado cliente:<br><br> Le Informamos que su cuenta ha sido borrada.<br><br>Atentamente,<br><br>Dpto. de seguridad. ");
