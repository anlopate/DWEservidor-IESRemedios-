...
<head>
    ...
    <title>Login - Clientes Gesbank</title>
</head>
<?php require_once("template/partials/head.php") ?>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control <?= (isset($this->errores['email']))? 'is-invalid': null ?>" name="email" value="<?= $this->email; ?>" required autocomplete="email" autofocus><!--en la class form-control, comprueba si existe error en el email, si existe crea una imagen is-invalid-->
