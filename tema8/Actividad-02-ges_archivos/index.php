<?php	
	...
	// $_Request, contiene tanto GET como POST
...
<body>
	...
	<br><br><br><br>
		...
		<!-- No se pone el atributo action porque este mismo archivo el que procesa el formulario -->
		...
		<div class="card">
			...
			<!-- A los botones se le añade nombre para crear la variable con ese nombre $_REQUEST['nombredelboton'] -->
			<div class="card-header">
			...
			<!-- Pantalla de alerta qeu aparace cuando pinchamos una opción del menú (subir, crear, etc)
			Va dentro de form porque es un formulario-->
