<?php 
	...
	class explorador { 
		...
		// Me devuelve todas las carptes y todos los archivos, lo indico con *.
		...
		//Primero compruebo que es un directorio. Establece directorio actual
		...
		// Si al eliminar, es un archivo no hay problema.
		// Al eliminar el directorio, se hace utiliza recursividad.
		...
		// Función Recursiva
		// La función se llama asi misma hasta que la carpeta quede vacía.
		// La función que ejecuta es rmdir
       ...
       // $archivos es un array con los archivos seleccionados.
		...
		// Función recursiva. Para comprimir una carpeta, tengo que recorrerla e ir añadiendo el contenido al archivo zip.
