    ...
    public function enviarImagen($param = []){
         ...
         if (!isset($_SESSION['id'])) {
             ...
             header('location:' . URL . 'album');
              ...
              # Comprobamos la validación llamando al método subirAcarpeta del modelo
              $this->model->subirACarpeta($_FILES['fichero'],$carpetaImagen->carpeta);
            ...
            //     $numeroFotos = count(glob('images/'.$carpetaImagen->carpeta."/*"));
