    ...
    <div class="container">
        ...
        <form action="<?= URL ?>album/update/<?= $this->id ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="autor" value="<?=$this->album->autor ?>">
                <!-- Mostrar posible error -->
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="fecha" value="<?=$this->album->fecha ?>">
                <!-- Mostrar posible error -->
            ...
            <div class="mb-3">
                ...
                <input type="carpeta" class="form-control" name="carpeta" value="<?=$this->album->carpeta ?>">
                 <!-- Mostrar posible error -->
            ...
            <!-- botones de acción -->
            <a class="btn btn-secondary" href="<?= URL ?>carpeta" role="button">Cancelar</a>
