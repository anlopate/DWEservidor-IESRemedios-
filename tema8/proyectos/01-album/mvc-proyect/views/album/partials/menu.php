            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/4">Categoría</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/5">Etiquetas</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/6">Num_fotos</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/7">Num_visitas</a></li>
